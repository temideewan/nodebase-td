...
const triggerNodes: NodeTypeOption[] = [
  {
    ...
    description: 'Get started quickly. Runs the flow on the click of a button',
        ...
        <div>
          {triggerNodes.map((nodeType) => {
            ...
            return (
              <div
                key={nodeType.type}
                className='w-full justify-start py-5 px-4 h-auto rounded-none border-l-2 border-transparent hover:border-l-primary cursor-pointer'
